...
public class BookController {
    ...
    public ResponseEntity<StockResponse> checkAvailability(@PathVariable UUID id) {
    ...
    public ResponseEntity<StockResponse> decrementStock(@PathVariable UUID id) {
    ...
    public ResponseEntity<StockResponse> incrementStock(@PathVariable UUID id) {
