...
import com.elib.core.mapper.UserMapper;
import com.elib.core.repository.UserRepository;
...
public class UserService {
    ...
    public UserResponse createUser(UserRequest request) {
        ...
        roles.add("USER"); // Changed from "ROLE_USER" to match your seed data 'USER'
        user.setRoles(roles);
